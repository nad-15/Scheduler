...
const CACHE_NAME = 'scheduler-pwa-v115';
...
const STATIC_ASSETS = [
    ...
    './js/script.js',
    './js/dynamic-input-bar.js',
    './js/cat-runner.js',
    './images/cat/WALK.png',
    './images/cat/IDLE.png',
    './images/cat/JUMP.png',
    './images/cat/RUNNING_JUMP.png',
    './images/cat/RUN.png',
    './images/cat/ATTACK.png',
    './images/cat/HURT.png',
    './js/job-template.js',
    './js/weather.js',
    './js/to-do.js',
    ...
    './images/weather/rainbow-clear.svg',
    ...
    './images/weather/wind-spinner.svg',
